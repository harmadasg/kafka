...
public enum ApiKeys {
    ...
    CREATE_VIRTUAL_CLUSTER(ApiMessageType.CREATE_VIRTUAL_CLUSTER, false, true),
    DELETE_VIRTUAL_CLUSTER(ApiMessageType.DELETE_VIRTUAL_CLUSTER, false, true),
    ALTER_VIRTUAL_CLUSTER(ApiMessageType.ALTER_VIRTUAL_CLUSTER, false, true),
    LIST_VIRTUAL_CLUSTER(ApiMessageType.LIST_VIRTUAL_CLUSTERS, false, true),
    DESCRIBE_VIRTUAL_CLUSTER(ApiMessageType.DESCRIBE_VIRTUAL_CLUSTER, false, true);
